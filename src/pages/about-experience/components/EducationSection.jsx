  ...
  return (
    ...
    >
      ...
      <div className="flex items-center space-x-3 mb-8">
        ...
        <h2 className="text-3xl lg:text-4xl font-bold text-white">Education & Learning</h2>
      </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-4">
              <div className="flex items-start space-x-4 mb-4 sm:mb-0">
                ...
                <div>
                  ...
                  {edu.field && <p className="text-sm text-white/80">{edu.field}</p>}
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {edu.coursework.map((course, courseIndex) => (
                      <li key={courseIndex} className="flex items-start space-x-2 text-sm text-white/80">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {edu.achievements?.map((achievement, achIndex) => (
                      <li key={achIndex} className="flex items-start space-x-2 text-sm text-white/80">
